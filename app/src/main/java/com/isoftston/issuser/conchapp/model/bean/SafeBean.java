...
public class SafeBean {
    ...
    public void setYHWYS(int YHWYS) {
        this.YHWYS = YHWYS;
    }
    ...
    public void setYHWZG(int YHWZG) {
        this.YHWZG = YHWZG;
    }
