...
public final class CaptureActivity extends Activity implements SurfaceHolder.Callback {
    ...
    public void handleDecode(Result rawResult, Bitmap barcode, float scaleFactor) {
        Log.e("czy", "handleDecode::" + rawResult.getText());
        Intent intent = new Intent();
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        if (mScanAnimator == null) {
            int height = capture_crop_view.getMeasuredHeight() - 25;
            mScanAnimator = ObjectAnimator.ofFloat(capture_scan_line, "translationY", 0F, height).setDuration(5000);
